...
public class OurData {
    ...
    public static int[] firendlistDailyPicturePath = new int[]{
            R.drawable.profile_bengs,
            R.drawable.profile_seto,
            R.drawable.profile_septian,
            R.drawable.profile_ipul,
            R.drawable.profile_arif,
            R.drawable.profile_ucok,
            R.drawable.profile_puck,
            R.drawable.profile_juan,
            R.drawable.profile_hafidh,
            R.drawable.profile_caca,
            R.drawable.profile_dian
    };
    ...
    public static String[] title_music = new String[]{
        "PeeWeeGaskins - Here to Stay",
        "TheBeatles - I Will",
        "PeeWeeGaskins - You And I Going South",
        "Fiersa Besari - Heart Thee",
        "Sal Priadi - Amin Paling Serius",
